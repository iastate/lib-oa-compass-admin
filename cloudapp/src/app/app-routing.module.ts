...
const routes: Routes = [
  ...
  { path: 'settings', component: SettingsComponent, canActivate: [operatorAuthorizationGuard] },

  // Institution-level configuration (CloudAppConfigService)
  { path: 'config', component: ConfigComponent, canActivate: [operatorAuthorizationGuard] },
